...
def train_and_test():
    ...
    [X_train,Y_train] = get_input_and_ouptut_vectors(text,text_summ,10,40,1,model,no)
    ...
    #[X_test,Y_test] = get_input_and_ouptut_vectors(text,text_summ,501,550,2,model,no)
    ...
    print(test_accuracy)
    #generate_summary_file(text,Y_test_predicted,3515,4512)
